              ...
              <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                ...
                <a href="{{ route('users.index') }}"><button type="button" class="btn btn-danger btn-rounded btn-icon">
                  {{ __('View All Users') }}
                    ...
                    <div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="u_dpt">Department <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="u_dpt" name="u_dpt" required="required" class="form-control">
											</div>
										</div>
