...
@section('navbar')
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <!--logo-->
          <a class="navbar-brand brand-logo mr-5" href="{{ url('dashboard') }}"><img src="{{ asset('images/giz-logo-2.png') }}" class="mr-2" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="{{ url('dashboard') }}"><img src="{{ asset('images/giz-logo-2.png') }}" alt="GIZ logo"/></a>
        </div>
